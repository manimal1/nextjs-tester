...
export default function App() {
  const iconClasses = "rounded-lg h-[80px] w-[80px]";
    ...
    <main>
      ...
      <div className="flex items-center justify-center flex-wrap w-full space-x-8 space-y-8">
        ...
        <div className="h-[80px] w-[80px] bg-gray-100 rounded-lg flex items-center justify-center">
          <Image src="/vercel-icon.svg" alt="Vercel Logo" width={50} height={50} className={iconClasses} />
        </div>
        ...
        <div className="h-[80px] w-[80px] bg-gray-100 rounded-lg flex items-center justify-center">
          <Image src="/nextauth-icon.png" alt="Next Auth Logo" width={50} height={50} className={iconClasses} />
        </div>
      </div>
    </main>
  );
